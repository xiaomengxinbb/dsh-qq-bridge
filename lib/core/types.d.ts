...
export type QQGatewayState = "disconnected" | "connecting" | "connected" | "error";
...
/** 网关状态变化回调 */
export type QQGatewayStateListener = (state: QQGatewayState, info?: string) => void;
/** 入站消息回调（M1 接入 router） */
...
/** 附件分类（嗅探结果） */
export type QQAttachmentKind = "image" | "audio" | "pdf" | "doc" | "text" | "archive" | "unknown";
/** 预处理后的单个附件资源 */
